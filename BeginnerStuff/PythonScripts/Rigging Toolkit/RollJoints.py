...
def createShoulderTwistJoint(placeholderName, numJoints, firstJoint, secondJoint, sAxis, locatorOffset, zDirection,
    ...
    createMidTwists(placeholderName, numJoints, firstJoint, secondJoint, zDirection, endOfChain, True, aimLoc,
                    targetLoc)
...
def createLowerTwistJoint(placeholderName, numJoints, firstJoint, secondJoint, sAxis, locatorOffset, zDirection, endOfChain):
    # create the aim loc
    ...
    cmds.aimConstraint(targetLoc, aimLoc, o=(0, 0, 0), aim=(-zDirection, 0, 0), u=getUpAxis(sAxis, zDirection), wut='object',
                       wuo=upTargetLoc)
    createMidTwists(placeholderName, numJoints, firstJoint, secondJoint, zDirection, endOfChain, False, aimLoc,
                    targetLoc)
