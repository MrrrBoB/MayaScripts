...
sIKWindow = cmds.window(title="Make IK Stretch", widthHeight=(450, 175))
...
def CreateStretchButtonCommand():
    ...
    CreateIKStretch(chosenStartJoint, chosenBaseControl, chosenIKControl, chosenMaxStretch, needsReverseNode)


def CreateIKStretch(startJoint, baseControl, ikControl, maxStretchValue, needsReverseScalar):
