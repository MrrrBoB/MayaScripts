...
def createShoulderTwistJoint(placeholderName, numJoints, firstJoint, secondJoint, zDirection, endOfChain):
    isShoulder = True
    ...
    cmds.xform(upTargetLoc, r=1, t=(0, -3 * zDirection, 0))
    ...
    cmds.aimConstraint(targetLoc, aimLoc, o=(0, 0, 0), aim=(zDirection, 0, 0), u=(0, -1 * zDirection, 0), wut='object',
                       wuo=upTargetLoc)
    # create the joints
    ...
    cmds.xform(ikJointOne, r=1, os=1, t=(0, -3 * zDirection, 0))
    ...
    cmds.xform(ikJntPVLoc, os=1, r=1, t=(0, -2, 0))
...
def createTwistJoint(placeholderName, numJoints, firstJoint, secondJoint, zDirection, endOfChain):
    ...
    print(upTargetLoc)
    # if addConstraint:
    cmds.aimConstraint(targetLoc, aimLoc, o=(0, 0, 0), aim=(-1, 0, 0), u=(0, 0, -zDirection), wut='object',
                       wuo=upTargetLoc)
    createMidTwists(placeholderName, numJoints, firstJoint, secondJoint, zDirection, endOfChain, isShoulder, aimLoc,
                    targetLoc)
...
def twistButtonCommand():
    ...
    if cmds.checkBox(shoulderBox, q=1, v=1):
        createShoulderTwistJoint(nameF, numJ, chosenFirst, chosenSecond, zDir, endChain)
    else:
