...
line5Layout = cmds.rowLayout(numberOfColumns=2, columnAlign=(1, 'right'))
instructionLine5 = cmds.text(l='5. Orient and mirror skeleton')
orientMirrorButton = cmds.button(l='Orient and Mirror', command='OrientMirrorButton()')
cmds.setParent('..')
